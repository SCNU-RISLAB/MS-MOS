...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default='/data/datasets/dataset/kitti_dataset',
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default='/data/zlf/mos3d/mos3d_refine_e3_l1.5/2023-10-11-18:09_MotionRV_raw_valid_08',
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="/data/zlf/mos3d/MotionRV-2stage/config/labels/semantic-kitti-mos.raw.yaml",
